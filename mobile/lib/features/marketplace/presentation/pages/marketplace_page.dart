...
class _MarketplacePageState extends ConsumerState<MarketplacePage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      creators = await api.creators(q: query.isEmpty ? null : query);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(controller: _tabs, tabs: const [Tab(text: 'Creators'), Tab(text: 'Campaigns')]),
      ),
      body: Column(
        children: [
          Padding(
