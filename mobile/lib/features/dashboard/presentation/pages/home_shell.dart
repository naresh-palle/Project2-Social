...
class HomeShell extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isCreator = user?.isInfluencer == true || user?.role == 'influencer';
    final isBrand = user?.isOwner == true || user?.role == 'owner' || user?.role == 'agent';
        ...
        child: SafeArea(
          child: ListView(
            children: [
              ...
              if (isCreator || user?.isAdmin == true)
                ListTile(leading: const Icon(Icons.map_outlined), title: const Text('Campaign Map'), onTap: () { Navigator.pop(context); context.push('/campaigns/map'); }),
              ...
              ListTile(leading: const Icon(Icons.emoji_events_outlined), title: const Text('Leaderboard'), onTap: () { Navigator.pop(context); context.push('/leaderboard'); }),
              if (user?.isAdmin != true)
                ListTile(leading: const Icon(Icons.card_giftcard_outlined), title: const Text('Referrals'), onTap: () { Navigator.pop(context); context.push('/referrals'); }),
