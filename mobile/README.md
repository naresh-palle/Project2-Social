...
lib/
  ...
  features/
    auth/         # login, register, OTP, Google/Apple, onboarding
...
- Login: `POST /auth/login`, `/auth/google-login`, `/auth/apple-login`, mobile OTP, `/auth/mobile-register`
...
2. Set Team, Bundle ID (default `studio.cr8`), Sign in with Apple capability
