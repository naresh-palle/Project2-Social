    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-[#0B0B0E] flex flex-col items-center justify-center text-white p-6">
          ...
          <div className="bg-black/50 p-4 rounded-md border border-white/10 w-full max-w-2xl overflow-auto text-left">
          ...
          <button 
            className="mt-6 px-6 py-2 bg-white/10 hover:bg-white/20 rounded-md font-mono text-sm"
