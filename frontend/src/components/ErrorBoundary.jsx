...
export class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-[#0B1020] flex flex-col items-center justify-center text-white p-6">
          <h1 className="text-3xl font-bold text-[#FF5C5C] mb-4">Something went wrong.</h1>
