      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-[6.75rem] lg:bottom-[5.5rem] right-3 left-3 sm:left-auto sm:right-6 z-[60] w-auto sm:w-[380px] max-w-[calc(100vw-1.5rem)] min-w-0 h-[min(560px,calc(100dvh-11rem))] max-h-[calc(100dvh-7.5rem)] landscape:h-[min(420px,calc(100dvh-6.5rem))] landscape:max-h-[calc(100dvh-5.5rem)] border border-[#FF3B30]/35 rounded-3xl shadow-[0_20px_60px_rgba(255,59,48,0.25)] overflow-hidden flex flex-col"
            style={{
              backgroundColor: "#0B0B0E",
              backgroundImage: `linear-gradient(180deg, rgba(11,11,14,0.72) 0%, rgba(11,11,14,0.88) 55%, rgba(11,11,14,0.94) 100%), url(${process.env.PUBLIC_URL}/chat-panel-bg.png)`,
