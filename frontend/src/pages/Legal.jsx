...
const DOCS = {
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: "Campaign agreements between brands and influencers are facilitated through the Platform. Payment terms, deliverables, and dispute resolution are governed by campaign-specific agreements and our Escrow Policy.",
      },
      {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        h: "4. How We Use Data",
        p: "To operate accounts, facilitate influencer-brand collaborations, process payments, send service notifications, improve the Platform, comply with law, and—with consent—send marketing communications.",
      },
      {
        h: "5. Sharing",
  ...
  cookies: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: "OAuth providers (Google) and payment partners may set cookies during sign-in or checkout. Refer to their respective policies.",
      },
      {
