      ...
      <div className="flex-1 flex items-center justify-center pt-28 pb-16 px-6">
        ...
        >
          ...
          <h1 className="font-sans text-3xl md:text-4xl font-bold tracking-tight mt-2 leading-[1.15]">
            Reset <span className="italic text-[#FF5C5C]">password</span>
          </h1>

          {!token ? (
            <div className="mt-8 p-4 bg-[#FF5C5C]/10 border border-[#FF5C5C]/30 rounded-xs font-mono text-sm">
              This reset link is invalid or expired.{" "}
              <Link to="/forgot-password" className="text-[#FF5C5C] underline">Request a new one</Link>.
            </div>
          ) : (
            <form onSubmit={submit} className="mt-8 space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-transparent hairline-b py-3 pl-7 pr-10 focus:outline-none focus:border-[#FF5C5C] mt-2"
                  />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-transparent hairline-b py-3 focus:outline-none focus:border-[#FF5C5C] mt-2"
                />
              </div>
              <button
                type="submit"
