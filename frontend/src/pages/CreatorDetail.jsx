                  ...
                  <section>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                          {creator.portfolio.map((media, i) => (
                              isVideoUrl(media) ? (
                                <div key={i} className="relative w-full h-48 overflow-hidden bg-white/5">
                                  <video
                                    src={media}
                                    ...
                                    preload="metadata"
                                  />
                                  <span className="absolute bottom-2 left-2 font-mono text-[9px] tracking-widest uppercase bg-black/55 px-2 py-1">Reel</span>
                                </div>
                              ) : (
                                <img key={i} src={media} alt="" className="w-full h-48 object-cover transition-all duration-500" />
                              )
                          ))}
                      </div>
                  </section>
