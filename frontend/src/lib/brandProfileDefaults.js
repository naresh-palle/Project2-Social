...
export const ACME_BRAND_DEFAULTS = {
  bio:
    "Acme Brand is a fashion-forward apparel house building seasonal capsule collections for metro audiences across India. We partner with creators for product drops, lookbook reels, and city takeover stories — with escrow-backed briefs and clear brand guidelines.",
  ...
  past_campaigns: [
    ...
    {
      brand: "Acme Brand",
      title: "Festive Edit Creator Series",
      date: "2025-10",
      result: "2.1M reach",
      post_url: "https://instagram.com",
    },
...
export function withBrandDisplayDefaults(profile) {
  ...
  const defaults = isAcme ? d : {
    ...
    bio: profile.bio && !isSparseBrandBio(profile.bio)
      ? profile.bio
      : `${profile.company || profile.name || "This brand"} partners with creators on CR8 Studio for escrow-backed campaigns, product storytelling, and measurable reach across priority metros.`,
